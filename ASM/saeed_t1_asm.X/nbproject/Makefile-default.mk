...
FINAL_IMAGE=${DISTDIR}/saeed_t1_asm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=man.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/man.o
POSSIBLE_DEPFILES=${OBJECTDIR}/man.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/man.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/saeed_t1_asm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F84A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/saeed_t1_asm.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/man.o: man.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/man.o 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/saeed_t1_asm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F84A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/saeed_t1_asm.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
